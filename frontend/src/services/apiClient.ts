...
function toSummary(item: BackendSummary): DashboardSummary {
  ...
  return {
    ...
    avgHeartRate: averages.heart_rate ?? null,
    avgHrv: averages.hrv ?? null,
    avgTemperature: averages.temperature ?? null,
    avgEda: averages.eda ?? null,
    avgSdnn: averages.sdnn_ms ?? null,
    avgSpo2: averages.spo2_percent ?? null,
    avgScrPeakCount: averages.scr_peak_count ?? null,
    avgScrMean: averages.scr_mean ?? null,
    avgStressScore: averages.stress_score ?? null,
  };
}
